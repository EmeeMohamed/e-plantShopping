...
function ProductList({ onHomeClick }) {
    ...
    const plantsArray = [
        ...
        // (Other categories remain the same with cost as numbers — remove "$")
        // ... Aromatic, Insect Repellent, Medicinal, Low Maintenance
    ];
        ...
        <div>
            <div className="navbar" style={navbarStyle}>
                ...
                <div style={navLinksStyle}>
                    <div><a href="#" onClick={(e) => { e.preventDefault(); setShowCart(false); }} style={linkStyle}>Plants</a></div>
                    <div><a href="#" onClick={(e) => { e.preventDefault(); setShowCart(true); }} style={linkStyle}><h1 className='cart'>🛒</h1></a></div>
                </div>
            </div>
